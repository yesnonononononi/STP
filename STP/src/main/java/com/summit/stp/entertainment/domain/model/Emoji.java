...
public class Emoji {
    ...
    public void updateName(String newName){
        if(newName == null || newName.length() > BusinessRuleConstants.Emoji.MAX_NAME_LENGTH){
            throw new BusinessException("表情名长度不能大于" + BusinessRuleConstants.Emoji.MAX_NAME_LENGTH);
        }
        this.name = newName;
