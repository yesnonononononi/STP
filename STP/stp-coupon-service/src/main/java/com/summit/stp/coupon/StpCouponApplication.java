...
@ComponentScan(basePackages = {"com.summit.stp.coupon", "com.summit.stp.shared", "com.summit.stp.common"})
@MapperScan("com.summit.stp.coupon.infrastructure.persistence.mapper")
