...
public class UserAuthController {
    ...
    public Result<LoginVO> login(
            @ApiParam(value = "用户登录请求参数", required = true) @RequestBody @JsonTypeInfo(use = JsonTypeInfo.Id.CLASS,include = JsonTypeInfo.As.PROPERTY,property = "@class") LoginRequest request,
    ...
    public Result<RefreshTokenVO> refreshToken(
            @ApiParam(value = "刷新Token请求参数", required = true) @RequestBody @JsonTypeInfo(use = JsonTypeInfo.Id.CLASS,include = JsonTypeInfo.As.PROPERTY,property = "@class") RefreshTokenRequest request,
            HttpServletRequest httpServletRequest) {
