...
public interface CommentsMapper extends BaseMapper<CommentsPO> {
    List<CommentVO> queryCommentByPostIdWithCursor(@Param("lastCommentIdCursor") String lastCommentIdCursor, Long postId, Integer limit, @Param("lastHotScoreCursor") Double lastHotScoreCursor);
