...
import com.summit.stp.comment.comment.api.dto.request.CommentReplyQueryRequest;
import com.summit.stp.comment.comment.api.dto.request.CreateCommentRequest;
import com.summit.stp.comment.comment.api.dto.request.QueryCommentRequest;
import com.summit.stp.comment.comment.application.command.CommentReplyQueryCommand;
import com.summit.stp.comment.comment.application.command.CreateCommentCommand;
import com.summit.stp.comment.comment.application.command.QueryCommentCommand;
import com.summit.stp.comment.comment.application.service.CommentAppService;
import com.summit.stp.comment.comment.application.service.CommentQueryService;
...
public class CommentController {
    ...
    public Result<CommentVO> postComment(
        ...
        CreateCommentCommand command = CreateCommentCommand.builder()
                ...
                .build();
        CommentVO vo = commentAppService.postComment(command);
    ...
    @PostMapping("/report")
    public Result<Void> report(String reason,Long id){
        return commentAppService.report(reason,id);
    }
}
