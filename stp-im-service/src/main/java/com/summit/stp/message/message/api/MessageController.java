...
import com.summit.stp.message.message.api.dto.request.SendMessageRequest;
import com.summit.stp.message.message.application.command.CreateMessageCommand;
import com.summit.stp.message.message.application.service.InteractionMessageService;
...
import com.summit.stp.message.message.domain.model.EventName;
