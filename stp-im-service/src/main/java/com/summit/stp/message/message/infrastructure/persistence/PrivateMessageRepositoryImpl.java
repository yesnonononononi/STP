...
import com.summit.stp.message.message.domain.model.PrivateMessage;
import com.summit.stp.message.message.domain.repository.PrivateMessageRepository;
import com.summit.stp.message.message.infrastructure.persistence.po.PrivateMessagePO;
