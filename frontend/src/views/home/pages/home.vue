<template>
  ...
  <div class="min-h-screen w-full relative flex flex-col bg-linear-to-br from-blue-100/70 to-blue-200">
            ...
            <div class="w-full h-full flex flex-col">
              <div class="introduce flex-2 flex items-center p-2">
                ...
                <div class="introduce-info flex flex-col w-3/4 p-2 m-2">
                  <div class="nick flex items-center gap-2">
                    ...
                    <!-- 刷新用户信息图标 -->
                    <svg v-if="userProfile?.nick" t="1784879456307"
                      class="icon size-3 cursor-pointer text-gray-400 hover:text-blue-500 transition-all duration-300"
                      :class="isRefreshing ? 'animate-spin text-blue-500' : 'hover:scale-110 active:scale-95'"
                      viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6723"
                      ...
                      <path
                        ...
                        p-id="6724" fill="currentColor"></path>
                    </svg>
                  </div>
              ...
              <div class="items flex-3 mx-2 mt-4 pb-2">
                <div class="grid grid-cols-4 w-full gap-2">
                  <!-- 每日签到 -->
                  <div class="signin flex flex-col items-center cursor-pointer group/item relative"
                    @click="showDailySignIn = true">
                    <div class="relative size-12 flex items-center justify-center">
                      <svg t="1784189983423"
                        class="icon size-8 group-hover/item:scale-105 transition-transform duration-300"
                      ...
                      <!-- 未签到红点提示 -->
                      <span v-if="!isSignIn"
                        class="absolute top-1.5 right-2.5 size-2 bg-red-500 rounded-full animate-ping"></span>
                      <span v-if="!isSignIn" class="absolute top-1.5 right-2.5 size-2 bg-red-500 rounded-full"></span>
                    </div>
                    <div
                      class="text-[11px] text-gray-500 mt-1 font-medium group-hover/item:text-blue-500 transition-colors">
                      每日签到</div>
                  </div>
                  <!-- 收藏 -->
                  <div class="collected flex flex-col items-center cursor-pointer group/item"
                    @click="toUserProfile(userProfile?.id)">
                    <div class="size-12 flex items-center justify-center">
                      <svg class="w-6.5 h-6.5 group-hover/item:scale-110 transition-transform duration-300"
                        viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5336">
                        <path
                          d="M219.428571 73.142857h585.142858a109.714286 109.714286 0 0 1 109.714285 109.714286v697.088a73.142857 73.142857 0 0 1-99.766857 68.132571c-181.577143-71.021714-282.441143-106.496-302.518857-106.496-20.114286 0-120.941714 35.474286-302.518857 106.496A73.142857 73.142857 0 0 1 109.714286 879.908571V182.857143a109.714286 109.714286 0 0 1 109.714285-109.714286z"
                          fill="#FFB156" p-id="5337"></path>
                        <path
                          d="M914.285714 182.857143v438.857143H512V73.142857h292.571429a109.714286 109.714286 0 0 1 109.714285 109.714286zM109.714286 292.571429h402.285714v402.285714H109.714286z"
                          fill="#FEC965" p-id="5338"></path>
                        <path d="M512 292.571429h402.285714v402.285714H512z" fill="#FFB156" p-id="5339"></path>
                        <path
                          d="M494.994286 630.674286l-79.177143 41.618285a18.285714 18.285714 0 0 1-26.514286-19.273142l15.104-88.137143a36.571429 36.571429 0 0 0-10.532571-32.402286l-64-62.427429A18.285714 18.285714 0 0 1 339.931429 438.857143l88.502857-12.836572a36.571429 36.571429 0 0 0 27.538285-20.004571l39.606858-80.237714a18.285714 18.285714 0 0 1 32.768 0l39.606857 80.237714a36.571429 36.571429 0 0 0 27.538285 20.004571l88.502858 12.836572a18.285714 18.285714 0 0 1 10.130285 31.195428L630.125714 532.48a36.571429 36.571429 0 0 0-10.532571 32.365714l15.104 88.137143a18.285714 18.285714 0 0 1-26.514286 19.309714l-79.177143-41.618285a36.571429 36.571429 0 0 0-34.011428 0z"
                          fill="#FFFFFF" p-id="5340"></path>
                      </svg>
                    </div>
                    <div
                      class="text-[11px] text-gray-500 mt-1 font-medium group-hover/item:text-blue-500 transition-colors">
                  ...
                  <!-- 我的订单 -->
                  <div class="orders flex flex-col items-center cursor-pointer group/item"
                    @click="router.push({ name: 'orders' })">
                    <div class="size-12 flex items-center justify-center">
                      <svg class="w-6.5 h-6.5 group-hover/item:scale-110 transition-transform duration-300"
                        viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5352">
                        <path
                          d="M768 128a85.333333 85.333333 0 0 1 85.12 78.933333L853.333333 213.333333v597.333334a85.333333 85.333333 0 0 1-78.933333 85.12L768 896H256a85.333333 85.333333 0 0 1-85.12-78.933333L170.666667 810.666667V213.333333a85.333333 85.333333 0 0 1 85.333333-85.333333 42.666667 42.666667 0 0 1 4.992 85.034667L256 213.333333v597.333334h512V213.333333l-4.992-0.298666A42.666667 42.666667 0 0 1 768 128z"
                          fill="#049DEE" p-id="5353"></path>
                        <path
                        ...
                        <path
                          d="M640 554.666667a42.666667 42.666667 0 0 1 4.992 85.034666L640 640H384a42.666667 42.666667 0 0 1-4.992-85.034667L384 554.666667h256z m0-170.666667a42.666667 42.666667 0 0 1 4.992 85.034667L640 469.333333H384a42.666667 42.666667 0 0 1-4.992-85.034666L384 384h256z"
                          fill="#03CD8E" p-id="5355"></path>
                      </svg>
                    </div>
                    <div
                      class="text-[11px] text-gray-500 mt-1 font-medium group-hover/item:text-blue-500 transition-colors">
              ...
              <div class="settings flex-1 flex  border-t  border-gray-100 ">
                <div
                  class="w-1/2 flex items-center justify-center hover:text-blue-600  hover:bg-gray-100 cursor-pointer"
                  @click="router.push({ name: 'userSettings' })">账号设置</div>
                <div class="w-1/2 flex items-center justify-center hover:text-blue-600 hover:bg-gray-100 cursor-pointer"
                  @click="logout">
                  退出登录
                </div>
              </div>
    ...
    <!-- 底部 Footer 页脚组件 -->
    <footer
      class="w-full bg-[#161719] text-gray-500 py-8 px-4 md:px-12 border-t border-stone-900 text-xs shrink-0 select-none mt-auto">
      <div class="w-full max-w-[1200px] m-auto flex flex-col gap-6">
        ...
        <div class="flex flex-col lg:flex-row items-center justify-between gap-6 border-b border-stone-800/60 pb-6">
          <div class="flex flex-wrap items-center justify-center lg:justify-start gap-x-6 gap-y-3 text-stone-400">
            <span class="flex items-center transition-colors duration-200 hover:text-blue-400 cursor-pointer">
              ...
              <svg class="w-3.5 h-3.5 mr-1.5 fill-current text-stone-500 animate-pulse" viewBox="0 0 24 24">
                <path
                  d="M17 1H7c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-2-2-2zm-5 21c-.83 0-1.5-.67-1.5-1.5S11.17 19 12 19s1.5.67 1.5 1.5S12.83 22 12 22zm5-4H7V4h10v14z" />
              </svg>
              移动版
            </span>
          ...
          <div class="flex items-center gap-6">
            ...
            <div class="flex items-center gap-3">
              <!-- 微信 -->
              <span
                class="group flex items-center justify-center w-8 h-8 rounded-full border border-stone-800 hover:border-emerald-500 hover:bg-emerald-500/10 cursor-pointer transition-all duration-300">
                <svg class="w-4 h-4 text-stone-400 group-hover:text-emerald-400 transition-colors duration-300"
                  viewBox="0 0 24 24" fill="currentColor">
                  <path
                    d="M8.2 14.5c.3 0 .5-.2.5-.5s-.2-.5-.5-.5-.5.2-.5.5.2.5.5.5zm3.8 0c.3 0 .5-.2.5-.5s-.2-.5-.5-.5-.5.2-.5.5.2.5.5.5zm-.3-8.8C7.2 5.7 3 8.7 3 12.6c0 2.1 1.3 3.9 3.3 4.9l.4.5-.3 1.1c-.1.2 0 .4.2.4.2 0 .8-.3 1.4-.7.4.1.7.1 1 .1 4.3 0 7.8-2.6 7.8-6.6.1-3.9-3.9-6.7-7.8-6.7zm8 10.3c1.4-.7 2.3-2 2.3-3.5 0-2.9-3-5-6.1-5-1.1 0-2.1.3-3 .7.7.8 1.3 1.7 1.5 2.8 3.3.4 6.3 2.5 6.3 5.7 0 1.5-1 2.8-2.5 3.5l-.3.4.2.9c0 .1 0 .2-.1.2h-.1c-.2 0-.7-.2-1.1-.5-.3.1-.6.1-.9.1 0 .6-.2 1.3-.6 1.9 2.5-.1 4.9-1.7 5.1-2.4zm-5.3-1.8c.2 0 .4-.2.4-.4s-.2-.4-.4-.4-.4.2-.4.4.2.4.4.4zm2.5 0c.2 0 .4-.2.4-.4s-.2-.4-.4-.4-.4.2-.4.4.2.4.4.4z" />
                </svg>
              </span>
              <!-- 微博 -->
              <span
                class="group flex items-center justify-center w-8 h-8 rounded-full border border-stone-800 hover:border-red-500 hover:bg-red-500/10 cursor-pointer transition-all duration-300">
                <svg class="w-4 h-4 text-stone-400 group-hover:text-red-400 transition-colors duration-300"
                  viewBox="0 0 24 24" fill="currentColor">
                  <path
              ...
              <!-- QQ -->
              <span
                class="group flex items-center justify-center w-8 h-8 rounded-full border border-stone-800 hover:border-blue-500 hover:bg-blue-500/10 cursor-pointer transition-all duration-300">
                <svg class="w-4 h-4 text-stone-400 group-hover:text-blue-400 transition-colors duration-300"
                  viewBox="0 0 24 24" fill="currentColor">
                  <path
              ...
              <!-- Github -->
              <span
                class="group flex items-center justify-center w-8 h-8 rounded-full border border-stone-800 hover:border-stone-300 hover:bg-stone-300/10 cursor-pointer transition-all duration-300">
                <svg class="w-4 h-4 text-stone-400 group-hover:text-stone-200 transition-colors duration-300"
                  viewBox="0 0 24 24" fill="currentColor">
                  <path
        ...
        <!-- 第二行：公司地址及联系方式 -->
        <div
          class="flex flex-col md:flex-row flex-wrap items-center justify-center gap-y-2 gap-x-6 text-stone-500 text-center">
        ...
        <!-- 第三行：版权和各种资质 -->
        <div
          class="flex flex-col lg:flex-row items-center justify-between gap-4 text-stone-600 text-center lg:text-left pt-2 border-t border-stone-800/40">
          <div class="flex flex-wrap items-center justify-center lg:justify-start gap-x-2 gap-y-1">
            ...
            <a href="mailto:contact@stp-social.com"
              class="hover:text-stone-400 transition-colors">contact@stp-social.com</a>
            <span class="text-stone-700 mx-1">|</span>
            <a href="https://beian.miit.gov.cn/" target="_blank"
              class="hover:text-stone-400 transition-colors">蜀ICP备20260716号-1</a>
          </div>
          <div class="flex flex-wrap items-center justify-center lg:justify-end gap-x-4 gap-y-2">
            ...
            <a href="http://www.beian.gov.cn/" target="_blank"
              class="flex items-center hover:text-stone-400 transition-colors">
...
async function refreshUserInfo() {
  if (!authStore.token || isRefreshing.value) return;
  try {
