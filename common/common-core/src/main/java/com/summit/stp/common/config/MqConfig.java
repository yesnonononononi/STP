...
public class MqConfig {
    ...
    public Queue userChangeQueue() {
        return QueueBuilder.durable(MqConstants.User.QUEUE_CHANGE).build();
    }
    ...
    @Bean
    public Queue userEsUpdateQueue() {
        return QueueBuilder.durable(MqConstants.User.QUEUE_ES_UPDATE).build();
    }

    @Bean
    public Binding userChangeBinding(Queue userChangeQueue, TopicExchange userExchange) {
        return BindingBuilder.bind(userChangeQueue).to(userExchange).with(MqConstants.User.ROUTING_KEY_CHANGE);
    }
    ...
    @Bean
    public Binding userEsUpdateBinding(Queue userEsUpdateQueue, TopicExchange userExchange) {
        return BindingBuilder.bind(userEsUpdateQueue).to(userExchange).with(MqConstants.User.ROUTING_KEY_ES_UPDATE);
    }
